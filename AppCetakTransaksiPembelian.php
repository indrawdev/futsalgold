...
<form name="form1" method="post" action="AppCetakTransaksiPembelianShow.php" target="_blank">
...
<table width="297" border="0" align="center" cellpadding="0" cellspacing="0" class="ins">	
        ...
        <tr>
          <th colspan="2" align="center" class="bleftright"><input type="submit" name="button" id="button" value="Laporan Pembelian" class="tombol"/></th>
        </tr>
