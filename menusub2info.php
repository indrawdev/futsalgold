...
//
// Table class for menusub2
//
class cmenusub2 extends cTable {
	var $ID;
	var $_Menu;
	var $Link;
	var $Parent;
	...
	function __construct() {
		...
		$this->TableVar = 'menusub2';
		$this->TableName = 'menusub2';
		...
		// ID
		$this->ID = new cField('menusub2', 'menusub2', 'x_ID', 'ID', '`ID`', '`ID`', 3, -1, FALSE, '`ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['ID'] = &$this->ID;

		// Menu
		$this->_Menu = new cField('menusub2', 'menusub2', 'x__Menu', 'Menu', '`Menu`', '`Menu`', 200, -1, FALSE, '`Menu`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Menu'] = &$this->_Menu;

		// Link
		$this->Link = new cField('menusub2', 'menusub2', 'x_Link', 'Link', '`Link`', '`Link`', 200, -1, FALSE, '`Link`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Link'] = &$this->Link;

		// Parent
		$this->Parent = new cField('menusub2', 'menusub2', 'x_Parent', 'Parent', '`Parent`', '`Parent`', 200, -1, FALSE, '`Parent`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Parent'] = &$this->Parent;

		// No
		$this->No = new cField('menusub2', 'menusub2', 'x_No', 'No', '`No`', '`No`', 3, -1, FALSE, '`No`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->No->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['No'] = &$this->No;

		// Akses
		$this->Akses = new cField('menusub2', 'menusub2', 'x_Akses', 'Akses', '`Akses`', '`Akses`', 200, -1, FALSE, '`Akses`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetMasterFilter() {
		...
		// Master filter
		$sMasterFilter = "";
		if ($this->getCurrentMasterTable() == "menusub1") {
			if ($this->Parent->getSessionValue() <> "")
				$sMasterFilter .= "`Menu`=" . ew_QuotedValue($this->Parent->getSessionValue(), EW_DATATYPE_STRING);
			else
				return "";
		}
	...
	// Master filter
	function SqlMasterFilter_menusub1() {
		return "`Menu`='@_Menu@'";
	}

	// Detail filter
	function SqlDetailFilter_menusub1() {
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("menusub2view.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("menusub2view.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "menusub2add.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("menusub2edit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("menusub2add.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("menusub2delete.php", $this->UrlParm());
	}
