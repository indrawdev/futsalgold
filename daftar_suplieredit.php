...
$daftar_suplier_edit = NULL; // Initialize page object first

class cdaftar_suplier_edit extends cdaftar_suplier {
	...
	// Page object name
	var $PageObjName = 'daftar_suplier_edit';
	...
	function Page_Main() {
		...
		if ($this->ID->CurrentValue == "")
			$this->Page_Terminate("daftar_suplierlist.php"); // Invalid key, return to list
...
// Create page object
if (!isset($daftar_suplier_edit)) $daftar_suplier_edit = new cdaftar_suplier_edit();

// Page init
$daftar_suplier_edit->Page_Init();

// Page main
$daftar_suplier_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$daftar_suplier_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var daftar_suplier_edit = new ew_Page("daftar_suplier_edit");
daftar_suplier_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = daftar_suplier_edit.PageID; // For backward compatibility

// Form object
var fdaftar_suplieredit = new ew_Form("fdaftar_suplieredit");

// Validate form
fdaftar_suplieredit.Validate = function() {
...
fdaftar_suplieredit.Form_CustomValidate = 
...
fdaftar_suplieredit.ValidateRequired = true;
<?php } else { ?>
fdaftar_suplieredit.ValidateRequired = false; 
<?php } ?>
...
<?php $daftar_suplier_edit->ShowPageHeader(); ?>
<?php
$daftar_suplier_edit->ShowMessage();
?>
<form name="fdaftar_suplieredit" id="fdaftar_suplieredit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="daftar_suplier">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_daftar_suplieredit" class="table table-bordered table-striped">
...
<input type="hidden" data-field="x_ID" name="x_ID" id="x_ID" value="<?php echo ew_HtmlEncode($daftar_suplier->ID->CurrentValue) ?>">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("EditBtn") ?></button>
</form>
<script type="text/javascript">
fdaftar_suplieredit.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$daftar_suplier_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$daftar_suplier_edit->Page_Terminate();
?>
