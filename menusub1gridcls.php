...
$menusub1_grid = NULL; // Initialize page object first

class cmenusub1_grid extends cmenusub1 {
	...
	// Page object name
	var $PageObjName = 'menusub1_grid';

	// Grid form hidden field names
	var $FormName = 'fmenusub1grid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["menusub1"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "_menu") {
			...
			if ($GLOBALS["_menu"]->EventCancelled) $this->EventCancelled = TRUE;
		}
