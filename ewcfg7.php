...
define("EW_PROJECT_NAME", "Futsal", TRUE); // Project name
define("EW_RANDOM_KEY", 'qdCul0yKpMUED55b', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "Futsal.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_DB", "futsalgold", TRUE);
