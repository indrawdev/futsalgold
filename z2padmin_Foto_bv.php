...
// Create page object
$z2padmin_Foto_blobview = new cz2padmin_Foto_blobview();
$Page =& $z2padmin_Foto_blobview;

// Page init
$z2padmin_Foto_blobview->Page_Init();

// Page main
$z2padmin_Foto_blobview->Page_Main();
?>
<?php
$z2padmin_Foto_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class cz2padmin_Foto_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'z2padmin_Foto_blobview';
	...
	//
	function cz2padmin_Foto_blobview() {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('2padmin');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('z2padmin', 'x_Foto');
		...
		if ($rs = $conn->Execute($sSql)) {
			if (!$rs->EOF) {
				...
				$objBinary->Value = $rs->fields('Foto');
