...
$daftar_pelanggan_add = NULL; // Initialize page object first

class cdaftar_pelanggan_add extends cdaftar_pelanggan {
	...
	// Page object name
	var $PageObjName = 'daftar_pelanggan_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "daftar_pelangganview.php")
...
// Create page object
if (!isset($daftar_pelanggan_add)) $daftar_pelanggan_add = new cdaftar_pelanggan_add();

// Page init
$daftar_pelanggan_add->Page_Init();

// Page main
$daftar_pelanggan_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$daftar_pelanggan_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var daftar_pelanggan_add = new ew_Page("daftar_pelanggan_add");
daftar_pelanggan_add.PageID = "add"; // Page ID
var EW_PAGE_ID = daftar_pelanggan_add.PageID; // For backward compatibility

// Form object
var fdaftar_pelangganadd = new ew_Form("fdaftar_pelangganadd");

// Validate form
fdaftar_pelangganadd.Validate = function() {
...
fdaftar_pelangganadd.Form_CustomValidate = 
...
fdaftar_pelangganadd.ValidateRequired = true;
<?php } else { ?>
fdaftar_pelangganadd.ValidateRequired = false; 
<?php } ?>
...
<?php $daftar_pelanggan_add->ShowPageHeader(); ?>
<?php
$daftar_pelanggan_add->ShowMessage();
?>
<form name="fdaftar_pelangganadd" id="fdaftar_pelangganadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="daftar_pelanggan">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_daftar_pelangganadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
fdaftar_pelangganadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$daftar_pelanggan_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$daftar_pelanggan_add->Page_Terminate();
?>
