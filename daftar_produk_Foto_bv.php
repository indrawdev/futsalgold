...
$daftar_produk_Foto_blobview = NULL; // Initialize page object first

class cdaftar_produk_Foto_blobview extends cdaftar_produk {
	...
	// Page object name
	var $PageObjName = 'daftar_produk_Foto_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'daftar produk');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('daftar_produk', 'x_Foto');
...
// Create page object
if (!isset($daftar_produk_Foto_blobview)) $daftar_produk_Foto_blobview = new cdaftar_produk_Foto_blobview();

// Page init
$daftar_produk_Foto_blobview->Page_Init();

// Page main
$daftar_produk_Foto_blobview->Page_Main();
?>
<?php
$daftar_produk_Foto_blobview->Page_Terminate();
?>
