...
$menusub1_edit = NULL; // Initialize page object first

class cmenusub1_edit extends cmenusub1 {
	...
	function Page_Main() {
		...
		if ($this->ID->CurrentValue == "")
			$this->Page_Terminate("menusub1list.php"); // Invalid key, return to list
	...
	function ValidateForm() {
		...
		if (in_array("menusub2", $DetailTblVar) && $GLOBALS["menusub2"]->DetailEdit) {
		...
		if ($rs->EOF) {
			...
			if ($bUpdateRow) {
				...
				if ($EditRow) {
					...
					if (in_array("menusub2", $DetailTblVar) && $GLOBALS["menusub2"]->DetailEdit) {
						if (!isset($GLOBALS["menusub2_grid"])) $GLOBALS["menusub2_grid"] = new cmenusub2_grid(); // Get detail page object
						$EditRow = $GLOBALS["menusub2_grid"]->GridUpdate();
					}
				}
	...
	function SetUpDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("menusub2", $DetailTblVar)) {
				...
				if ($GLOBALS["menusub2_grid"]->DetailEdit) {
					$GLOBALS["menusub2_grid"]->CurrentMode = "edit";
					$GLOBALS["menusub2_grid"]->CurrentAction = "gridedit";
...
// Create page object
if (!isset($menusub1_edit)) $menusub1_edit = new cmenusub1_edit();

// Page init
$menusub1_edit->Page_Init();

// Page main
$menusub1_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$menusub1_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var menusub1_edit = new ew_Page("menusub1_edit");
menusub1_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = menusub1_edit.PageID; // For backward compatibility

// Form object
var fmenusub1edit = new ew_Form("fmenusub1edit");

// Validate form
fmenusub1edit.Validate = function() {
...
fmenusub1edit.Form_CustomValidate = 
...
fmenusub1edit.ValidateRequired = true;
<?php } else { ?>
fmenusub1edit.ValidateRequired = false; 
<?php } ?>
...
<?php $menusub1_edit->ShowPageHeader(); ?>
<?php
$menusub1_edit->ShowMessage();
?>
<form name="fmenusub1edit" id="fmenusub1edit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="menusub1">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_menusub1edit" class="table table-bordered table-striped">
...
<input type="hidden" data-field="x_ID" name="x_ID" id="x_ID" value="<?php echo ew_HtmlEncode($menusub1->ID->CurrentValue) ?>">
<?php
	if (in_array("menusub2", explode(",", $menusub1->getCurrentDetailTable())) && $menusub2->DetailEdit) {
?>
