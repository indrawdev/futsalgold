...
<link rel="stylesheet" href="system.css" type="text/css" media="screen" />
	...
	<title>Rekapitulasi Transaksi Pembelian</title>
</head>
<body>

<?=FBR(2);?>

<form name="form1" method="post" action="AppCetakTransaksiPenjualanShow.php" target="_blank">
	
<table width="297" border="0" align="center" cellpadding="0" cellspacing="0" class="ins">	

		
		<tr>
		  <th align="right" class="tleft"><input id="exampleI" name="dateI" type="hidden" maxlength="10" />Dari :</th>
        ...
        <tr>
          <th colspan="2" align="center" class="bleftright"><input type="submit" name="button" id="button" value="Laporan Penjualan" class="tombol"/></th>
        </tr>
