...
class cp_menu_view extends c_menu {
	...
	function SetupOtherOptions() {
		...
		// Detail table 'menusub1'
		$body = $Language->TablePhrase("menusub1", "TblCaption");
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("menusub1list.php?" . EW_TABLE_SHOW_MASTER . "=_menu&MainMenu=" . strval($this->MainMenu->CurrentValue) . "") . "\">" . $body . "</a>";
		$item = &$option->Add("detail_menusub1");
		$item->Body = $body;
		$item->Visible = $Security->AllowList(CurrentProjectID() . 'menusub1');
		if ($item->Visible) {
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf__menu\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf__menu',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.f_menuview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
	...
	function SetUpDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("menusub1", $DetailTblVar)) {
				...
				if ($GLOBALS["menusub1_grid"]->DetailView) {
					$GLOBALS["menusub1_grid"]->CurrentMode = "view";
...
<?php if (!$p_menu_view->ExportOptions->UseDropDownButton) { ?>
</div>
...
?>
<form name="f_menuview" id="f_menuview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="_menu">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl__menuview" class="table table-bordered table-striped">
<?php if ($_menu->MainMenu->Visible) { // MainMenu ?>
	<tr id="r_MainMenu"<?php echo $_menu->RowAttributes() ?>>
		<td><span id="elh__menu_MainMenu"><?php echo $_menu->MainMenu->FldCaption() ?></span></td>
...
<?php echo $_menu->Akses->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
</table>
...
<?php
	if (in_array("menusub1", explode(",", $_menu->getCurrentDetailTable())) && $menusub1->DetailView) {
?>
