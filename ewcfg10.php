...
define("EW_PROJECT_NAME", "FutsalGold10Auto", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{FB59CACA-F11C-4CE1-B69A-4810252F4810}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'RdU1oyKc9l2vWv3Y', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/FutsalGold10Auto.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_HOST", $hostname_DS, TRUE);
define("EW_CONN_PORT", 3306, TRUE);
define("EW_CONN_USER", $username_DS, TRUE);
define("EW_CONN_PASS", $password_DS, TRUE);
define("EW_CONN_DB", $database_DS, TRUE);
...
define("EW_ADMIN_PASSWORD", "qazwsxedc", TRUE); // Administrator password
...
// User table filters
define("EW_USER_TABLE", "`2padmin`",  TRUE);
