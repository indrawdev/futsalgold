...
$p_2padmin_Foto_blobview = NULL; // Initialize page object first

class cp_2padmin_Foto_blobview extends c_2padmin {
	...
	// Page object name
	var $PageObjName = 'p_2padmin_Foto_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . '2padmin');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('_2padmin', 'x_Foto');
...
// Create page object
if (!isset($p_2padmin_Foto_blobview)) $p_2padmin_Foto_blobview = new cp_2padmin_Foto_blobview();

// Page init
$p_2padmin_Foto_blobview->Page_Init();

// Page main
$p_2padmin_Foto_blobview->Page_Main();
?>
<?php
$p_2padmin_Foto_blobview->Page_Terminate();
?>
