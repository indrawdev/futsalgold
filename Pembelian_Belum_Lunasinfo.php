...
$Pembelian_Belum_Lunas = NULL;

//
// Table class for Pembelian Belum Lunas
//
class cPembelian_Belum_Lunas extends cTable {
	var $ID;
	var $Tgl;
	var $No_Faktur;
	var $Grand_Total;
	...
	function __construct() {
		...
		$this->TableVar = 'Pembelian_Belum_Lunas';
		$this->TableName = 'Pembelian Belum Lunas';
		...
		// ID
		$this->ID = new cField('Pembelian_Belum_Lunas', 'Pembelian Belum Lunas', 'x_ID', 'ID', '`pembelian - master`.ID', '`pembelian - master`.ID', 3, -1, FALSE, '`pembelian - master`.ID', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['ID'] = &$this->ID;

		// Tgl
		$this->Tgl = new cField('Pembelian_Belum_Lunas', 'Pembelian Belum Lunas', 'x_Tgl', 'Tgl', '`pembelian - master`.Tgl', 'DATE_FORMAT(`pembelian - master`.Tgl, \'%d/%m/%Y\')', 133, 7, FALSE, '`pembelian - master`.Tgl', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Tgl->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['Tgl'] = &$this->Tgl;

		// No Faktur
		$this->No_Faktur = new cField('Pembelian_Belum_Lunas', 'Pembelian Belum Lunas', 'x_No_Faktur', 'No Faktur', '`pembelian - master`.`No Faktur`', '`pembelian - master`.`No Faktur`', 200, -1, FALSE, '`pembelian - master`.`No Faktur`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['No Faktur'] = &$this->No_Faktur;

		// Grand Total
		$this->Grand_Total = new cField('Pembelian_Belum_Lunas', 'Pembelian Belum Lunas', 'x_Grand_Total', 'Grand Total', '`pembelian - master`.`Grand Total`', '`pembelian - master`.`Grand Total`', 3, -1, FALSE, '`pembelian - master`.`Grand Total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Grand_Total->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Grand Total'] = &$this->Grand_Total;

		// Dibayar
		$this->Dibayar = new cField('Pembelian_Belum_Lunas', 'Pembelian Belum Lunas', 'x_Dibayar', 'Dibayar', '`pembelian - master`.Dibayar', '`pembelian - master`.Dibayar', 3, -1, FALSE, '`pembelian - master`.Dibayar', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Dibayar->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Dibayar'] = &$this->Dibayar;

		// SisaDibayar
		$this->SisaDibayar = new cField('Pembelian_Belum_Lunas', 'Pembelian Belum Lunas', 'x_SisaDibayar', 'SisaDibayar', '`pembelian - master`.SisaDibayar', '`pembelian - master`.SisaDibayar', 3, -1, FALSE, '`pembelian - master`.SisaDibayar', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->SisaDibayar->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['SisaDibayar'] = &$this->SisaDibayar;

		// Kode Supplier
		$this->Kode_Supplier = new cField('Pembelian_Belum_Lunas', 'Pembelian Belum Lunas', 'x_Kode_Supplier', 'Kode Supplier', '`pembelian - master`.`Kode Supplier`', '`pembelian - master`.`Kode Supplier`', 200, -1, FALSE, '`pembelian - master`.`Kode Supplier`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Kode Supplier'] = &$this->Kode_Supplier;

		// Kode Kasir
		$this->Kode_Kasir = new cField('Pembelian_Belum_Lunas', 'Pembelian Belum Lunas', 'x_Kode_Kasir', 'Kode Kasir', '`pembelian - master`.`Kode Kasir`', '`pembelian - master`.`Kode Kasir`', 200, -1, FALSE, '`pembelian - master`.`Kode Kasir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function SqlSelect() { // Select
		return "SELECT `pembelian - master`.ID, `pembelian - master`.Tgl, `pembelian - master`.`No Faktur`, `pembelian - master`.`Grand Total`, `pembelian - master`.Dibayar, `pembelian - master`.SisaDibayar, `pembelian - master`.`Kode Kasir`, `pembelian - master`.`Kode Supplier` FROM " . $this->SqlFrom();
	}

	function SqlWhere() { // Where
		$sWhere = "`pembelian - master`.SisaDibayar > 1";
		$this->TableFilter = "";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "Pembelian_Belum_Lunaslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("Pembelian_Belum_Lunasview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("Pembelian_Belum_Lunasview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "Pembelian_Belum_Lunasadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("Pembelian_Belum_Lunasedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("Pembelian_Belum_Lunasadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("Pembelian_Belum_Lunasdelete.php", $this->UrlParm());
	}
