...
function FSerial($NamaToko,$Pemilik,$Alamat,$Kota,$Telepon,$Email){
$Profile = md5($NamaToko.$Pemilik.$Alamat.$Kota.$Telepon.$Email."qazwsx123");
return $Profile;
}

function FUnlock($Serial,$KeyCode){
$Serial = md5($Serial."qazwsx123");
if (trim($Serial)==trim($KeyCode)){
return true;
}else{
return false;
}			
