...
$p_2padmin_edit = NULL; // Initialize page object first

class cp_2padmin_edit extends c_2padmin {
	...
	// Page object name
	var $PageObjName = 'p_2padmin_edit';
	...
	function Page_Main() {
		...
		if ($this->ID->CurrentValue == "")
			$this->Page_Terminate("_2padminlist.php"); // Invalid key, return to list
...
// Create page object
if (!isset($p_2padmin_edit)) $p_2padmin_edit = new cp_2padmin_edit();

// Page init
$p_2padmin_edit->Page_Init();

// Page main
$p_2padmin_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$p_2padmin_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var p_2padmin_edit = new ew_Page("p_2padmin_edit");
p_2padmin_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = p_2padmin_edit.PageID; // For backward compatibility

// Form object
var f_2padminedit = new ew_Form("f_2padminedit");

// Validate form
f_2padminedit.Validate = function() {
...
f_2padminedit.Form_CustomValidate = 
...
f_2padminedit.ValidateRequired = true;
<?php } else { ?>
f_2padminedit.ValidateRequired = false; 
<?php } ?>
...
<?php $p_2padmin_edit->ShowPageHeader(); ?>
<?php
$p_2padmin_edit->ShowMessage();
?>
<form name="f_2padminedit" id="f_2padminedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="_2padmin">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl__2padminedit" class="table table-bordered table-striped">
...
<?php if (!$Security->IsAdmin() && $Security->IsLoggedIn() && !$_2padmin->UserIDAllow("edit")) { // Non system admin ?>
...
<input type="hidden" data-field="x_ID" name="x_ID" id="x_ID" value="<?php echo ew_HtmlEncode($_2padmin->ID->CurrentValue) ?>">
