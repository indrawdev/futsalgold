...
$menusub2_edit = NULL; // Initialize page object first

class cmenusub2_edit extends cmenusub2 {
	...
	function Page_Main() {
		...
		if ($this->ID->CurrentValue == "")
			$this->Page_Terminate("menusub2list.php"); // Invalid key, return to list
		...
		switch ($this->CurrentAction) {
			case "I": // Get a record to display
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("menusub2list.php"); // No matching record, return to list
				}
				break;
			Case "U": // Update
...
// Create page object
if (!isset($menusub2_edit)) $menusub2_edit = new cmenusub2_edit();

// Page init
$menusub2_edit->Page_Init();

// Page main
$menusub2_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$menusub2_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var menusub2_edit = new ew_Page("menusub2_edit");
menusub2_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = menusub2_edit.PageID; // For backward compatibility

// Form object
var fmenusub2edit = new ew_Form("fmenusub2edit");

// Validate form
fmenusub2edit.Validate = function() {
...
fmenusub2edit.Form_CustomValidate = 
...
fmenusub2edit.ValidateRequired = true;
<?php } else { ?>
fmenusub2edit.ValidateRequired = false; 
<?php } ?>
...
<?php $menusub2_edit->ShowPageHeader(); ?>
<?php
$menusub2_edit->ShowMessage();
?>
<form name="fmenusub2edit" id="fmenusub2edit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="menusub2">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_menusub2edit" class="table table-bordered table-striped">
<?php if ($menusub2->ID->Visible) { // ID ?>
	<tr id="r_ID"<?php echo $menusub2->RowAttributes() ?>>
		<td><span id="elh_menusub2_ID"><?php echo $menusub2->ID->FldCaption() ?></span></td>
		<td<?php echo $menusub2->ID->CellAttributes() ?>><span id="el_menusub2_ID" class="control-group">
<span<?php echo $menusub2->ID->ViewAttributes() ?>>
<?php echo $menusub2->ID->EditValue ?></span>
<input type="hidden" data-field="x_ID" name="x_ID" id="x_ID" value="<?php echo ew_HtmlEncode($menusub2->ID->CurrentValue) ?>">
</span><?php echo $menusub2->ID->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($menusub2->_Menu->Visible) { // Menu ?>
	<tr id="r__Menu"<?php echo $menusub2->RowAttributes() ?>>
		<td><span id="elh_menusub2__Menu"><?php echo $menusub2->_Menu->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
		<td<?php echo $menusub2->_Menu->CellAttributes() ?>><span id="el_menusub2__Menu" class="control-group">
<input type="text" data-field="x__Menu" name="x__Menu" id="x__Menu" size="30" maxlength="100" placeholder="<?php echo $menusub2->_Menu->PlaceHolder ?>" value="<?php echo $menusub2->_Menu->EditValue ?>"<?php echo $menusub2->_Menu->EditAttributes() ?>>
</span><?php echo $menusub2->_Menu->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($menusub2->Link->Visible) { // Link ?>
	<tr id="r_Link"<?php echo $menusub2->RowAttributes() ?>>
		<td><span id="elh_menusub2_Link"><?php echo $menusub2->Link->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
		<td<?php echo $menusub2->Link->CellAttributes() ?>><span id="el_menusub2_Link" class="control-group">
<input type="text" data-field="x_Link" name="x_Link" id="x_Link" size="30" maxlength="255" placeholder="<?php echo $menusub2->Link->PlaceHolder ?>" value="<?php echo $menusub2->Link->EditValue ?>"<?php echo $menusub2->Link->EditAttributes() ?>>
</span><?php echo $menusub2->Link->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($menusub2->Parent->Visible) { // Parent ?>
	<tr id="r_Parent"<?php echo $menusub2->RowAttributes() ?>>
		<td><span id="elh_menusub2_Parent"><?php echo $menusub2->Parent->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
		<td<?php echo $menusub2->Parent->CellAttributes() ?>><span id="el_menusub2_Parent" class="control-group">
...
<input type="hidden" id="x_Parent" name="x_Parent" value="<?php echo ew_HtmlEncode($menusub2->Parent->CurrentValue) ?>">
<?php } else { ?>
<input type="text" data-field="x_Parent" name="x_Parent" id="x_Parent" size="30" maxlength="100" placeholder="<?php echo $menusub2->Parent->PlaceHolder ?>" value="<?php echo $menusub2->Parent->EditValue ?>"<?php echo $menusub2->Parent->EditAttributes() ?>>
<?php } ?>
</span><?php echo $menusub2->Parent->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($menusub2->No->Visible) { // No ?>
	<tr id="r_No"<?php echo $menusub2->RowAttributes() ?>>
		<td><span id="elh_menusub2_No"><?php echo $menusub2->No->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
		<td<?php echo $menusub2->No->CellAttributes() ?>><span id="el_menusub2_No" class="control-group">
<input type="text" data-field="x_No" name="x_No" id="x_No" size="30" placeholder="<?php echo $menusub2->No->PlaceHolder ?>" value="<?php echo $menusub2->No->EditValue ?>"<?php echo $menusub2->No->EditAttributes() ?>>
</span><?php echo $menusub2->No->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($menusub2->Akses->Visible) { // Akses ?>
	<tr id="r_Akses"<?php echo $menusub2->RowAttributes() ?>>
		<td><span id="elh_menusub2_Akses"><?php echo $menusub2->Akses->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
		<td<?php echo $menusub2->Akses->CellAttributes() ?>><span id="el_menusub2_Akses" class="control-group">
<select data-field="x_Akses" id="x_Akses[]" name="x_Akses[]" multiple="multiple"<?php echo $menusub2->Akses->EditAttributes() ?>>
<?php
...
</span><?php echo $menusub2->Akses->CustomMsg ?></td>
	</tr>
<?php } ?>
</table>
</td></tr></table>
