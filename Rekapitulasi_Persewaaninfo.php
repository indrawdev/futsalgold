...
$Rekapitulasi_Persewaan = NULL;

//
// Table class for Rekapitulasi Persewaan
//
class cRekapitulasi_Persewaan extends cTable {
	var $No_Faktur;
	var $Tgl;
	var $Kode;
	var $Nama;
	...
	function __construct() {
		...
		$this->TableVar = 'Rekapitulasi_Persewaan';
		$this->TableName = 'Rekapitulasi Persewaan';
		...
		// No Faktur
		$this->No_Faktur = new cField('Rekapitulasi_Persewaan', 'Rekapitulasi Persewaan', 'x_No_Faktur', 'No Faktur', '`persewaan lapangan - master`.`No Faktur`', '`persewaan lapangan - master`.`No Faktur`', 200, -1, FALSE, '`persewaan lapangan - master`.`No Faktur`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['No Faktur'] = &$this->No_Faktur;

		// Tgl
		$this->Tgl = new cField('Rekapitulasi_Persewaan', 'Rekapitulasi Persewaan', 'x_Tgl', 'Tgl', '`persewaan lapangan - master`.Tgl', 'DATE_FORMAT(`persewaan lapangan - master`.Tgl, \'%d/%m/%Y\')', 135, 7, FALSE, '`persewaan lapangan - master`.Tgl', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Tgl->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['Tgl'] = &$this->Tgl;

		// Kode
		$this->Kode = new cField('Rekapitulasi_Persewaan', 'Rekapitulasi Persewaan', 'x_Kode', 'Kode', '`persewaan lapangan - master`.Kode', '`persewaan lapangan - master`.Kode', 200, -1, FALSE, '`EV__Kode`', TRUE, TRUE, TRUE, 'FORMATTED TEXT');
		$this->fields['Kode'] = &$this->Kode;

		// Nama
		$this->Nama = new cField('Rekapitulasi_Persewaan', 'Rekapitulasi Persewaan', 'x_Nama', 'Nama', '`persewaan lapangan - master`.Nama', '`persewaan lapangan - master`.Nama', 200, -1, FALSE, '`persewaan lapangan - master`.Nama', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Nama'] = &$this->Nama;

		// Bayar
		$this->Bayar = new cField('Rekapitulasi_Persewaan', 'Rekapitulasi Persewaan', 'x_Bayar', 'Bayar', '`persewaan lapangan - master`.Bayar', '`persewaan lapangan - master`.Bayar', 3, -1, FALSE, '`persewaan lapangan - master`.Bayar', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Bayar->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Bayar'] = &$this->Bayar;

		// Sisa
		$this->Sisa = new cField('Rekapitulasi_Persewaan', 'Rekapitulasi Persewaan', 'x_Sisa', 'Sisa', '`persewaan lapangan - master`.Sisa', '`persewaan lapangan - master`.Sisa', 3, -1, FALSE, '`persewaan lapangan - master`.Sisa', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Sisa->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Sisa'] = &$this->Sisa;

		// Sub Total
		$this->Sub_Total = new cField('Rekapitulasi_Persewaan', 'Rekapitulasi Persewaan', 'x_Sub_Total', 'Sub Total', '`persewaan lapangan - master`.`Sub Total`', '`persewaan lapangan - master`.`Sub Total`', 3, -1, FALSE, '`persewaan lapangan - master`.`Sub Total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Sub_Total->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Sub Total'] = &$this->Sub_Total;

		// Diskon
		$this->Diskon = new cField('Rekapitulasi_Persewaan', 'Rekapitulasi Persewaan', 'x_Diskon', 'Diskon', '`persewaan lapangan - master`.Diskon', '`persewaan lapangan - master`.Diskon', 3, -1, FALSE, '`persewaan lapangan - master`.Diskon', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Diskon->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Diskon'] = &$this->Diskon;

		// Potongan
		$this->Potongan = new cField('Rekapitulasi_Persewaan', 'Rekapitulasi Persewaan', 'x_Potongan', 'Potongan', '`persewaan lapangan - master`.Potongan', '`persewaan lapangan - master`.Potongan', 3, -1, FALSE, '`persewaan lapangan - master`.Potongan', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Potongan->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Potongan'] = &$this->Potongan;

		// Grand Total
		$this->Grand_Total = new cField('Rekapitulasi_Persewaan', 'Rekapitulasi Persewaan', 'x_Grand_Total', 'Grand Total', '`persewaan lapangan - master`.`Grand Total`', '`persewaan lapangan - master`.`Grand Total`', 3, -1, FALSE, '`persewaan lapangan - master`.`Grand Total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Grand_Total->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Grand Total'] = &$this->Grand_Total;

		// Kode Kasir
		$this->Kode_Kasir = new cField('Rekapitulasi_Persewaan', 'Rekapitulasi Persewaan', 'x_Kode_Kasir', 'Kode Kasir', '`persewaan lapangan - master`.`Kode Kasir`', '`persewaan lapangan - master`.`Kode Kasir`', 200, -1, FALSE, '`persewaan lapangan - master`.`Kode Kasir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Kode Kasir'] = &$this->Kode_Kasir;

		// Status
		$this->Status = new cField('Rekapitulasi_Persewaan', 'Rekapitulasi Persewaan', 'x_Status', 'Status', '`persewaan lapangan - master`.Status', '`persewaan lapangan - master`.Status', 200, -1, FALSE, '`persewaan lapangan - master`.Status', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Status'] = &$this->Status;

		// ID
		$this->ID = new cField('Rekapitulasi_Persewaan', 'Rekapitulasi Persewaan', 'x_ID', 'ID', '`persewaan lapangan - master`.ID', '`persewaan lapangan - master`.ID', 3, -1, FALSE, '`persewaan lapangan - master`.ID', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function SqlSelect() { // Select
		return "SELECT `persewaan lapangan - master`.`No Faktur`, `persewaan lapangan - master`.Tgl, `persewaan lapangan - master`.Kode, `persewaan lapangan - master`.Nama, `persewaan lapangan - master`.Bayar, `persewaan lapangan - master`.Sisa, `persewaan lapangan - master`.`Sub Total`, `persewaan lapangan - master`.Diskon, `persewaan lapangan - master`.Potongan, `persewaan lapangan - master`.`Grand Total`, `persewaan lapangan - master`.`Kode Kasir`, `persewaan lapangan - master`.Status, `persewaan lapangan - master`.ID FROM " . $this->SqlFrom();
	}

	function SqlSelectList() { // Select for List page
		return "SELECT * FROM (" .
			"SELECT `persewaan lapangan - master`.`No Faktur`, `persewaan lapangan - master`.Tgl, `persewaan lapangan - master`.Kode, `persewaan lapangan - master`.Nama, `persewaan lapangan - master`.Bayar, `persewaan lapangan - master`.Sisa, `persewaan lapangan - master`.`Sub Total`, `persewaan lapangan - master`.Diskon, `persewaan lapangan - master`.Potongan, `persewaan lapangan - master`.`Grand Total`, `persewaan lapangan - master`.`Kode Kasir`, `persewaan lapangan - master`.Status, `persewaan lapangan - master`.ID, (SELECT CONCAT(`Kode`,'" . ew_ValueSeparator(1, $this->Kode) . "',`NamaPenyewa`) FROM `daftar pelanggan` `EW_TMP_LOOKUPTABLE` WHERE `EW_TMP_LOOKUPTABLE`.`Kode` = `persewaan lapangan - master`.Kode LIMIT 1) AS `EV__Kode` FROM `persewaan lapangan - master`" .
			") `EW_TMP_TABLE`";
	}
	...
	function SqlOrderBy() { // Order By
		return "`persewaan lapangan - master`.Tgl Desc";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "Rekapitulasi_Persewaanlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("Rekapitulasi_Persewaanview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("Rekapitulasi_Persewaanview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "Rekapitulasi_Persewaanadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("Rekapitulasi_Persewaanedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("Rekapitulasi_Persewaanadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("Rekapitulasi_Persewaandelete.php", $this->UrlParm());
	}
