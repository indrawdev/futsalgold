...
$menusub2_grid = NULL; // Initialize page object first

class cmenusub2_grid extends cmenusub2 {
	...
	// Page object name
	var $PageObjName = 'menusub2_grid';

	// Grid form hidden field names
	var $FormName = 'fmenusub2grid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["menusub2"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "menusub1") {
			...
			if ($GLOBALS["menusub1"]->EventCancelled) $this->EventCancelled = TRUE;
		}
