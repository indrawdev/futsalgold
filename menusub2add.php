...
$menusub2_add = NULL; // Initialize page object first

class cmenusub2_add extends cmenusub2 {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "menusub2view.php")
...
// Create page object
if (!isset($menusub2_add)) $menusub2_add = new cmenusub2_add();

// Page init
$menusub2_add->Page_Init();

// Page main
$menusub2_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$menusub2_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var menusub2_add = new ew_Page("menusub2_add");
menusub2_add.PageID = "add"; // Page ID
var EW_PAGE_ID = menusub2_add.PageID; // For backward compatibility

// Form object
var fmenusub2add = new ew_Form("fmenusub2add");

// Validate form
fmenusub2add.Validate = function() {
...
fmenusub2add.Form_CustomValidate = 
...
fmenusub2add.ValidateRequired = true;
<?php } else { ?>
fmenusub2add.ValidateRequired = false; 
<?php } ?>
...
<?php $menusub2_add->ShowPageHeader(); ?>
<?php
$menusub2_add->ShowMessage();
?>
<form name="fmenusub2add" id="fmenusub2add" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="menusub2">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_menusub2add" class="table table-bordered table-striped">
