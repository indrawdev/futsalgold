...
$profile_Foto_blobview = NULL; // Initialize page object first

class cprofile_Foto_blobview extends cprofile {
	...
	// Page object name
	var $PageObjName = 'profile_Foto_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('profile', 'x_Foto');
...
// Create page object
if (!isset($profile_Foto_blobview)) $profile_Foto_blobview = new cprofile_Foto_blobview();

// Page init
$profile_Foto_blobview->Page_Init();

// Page main
$profile_Foto_blobview->Page_Main();
?>
<?php
$profile_Foto_blobview->Page_Terminate();
?>
